...
CREATE TABLE IF NOT EXISTS audit_log (
    ...
    user_full_name TEXT,
    action_type TEXT NOT NULL,  -- CREATE, UPDATE, DELETE, VERIFY, LOGIN, SYNC, etc.
    entity_type TEXT NOT NULL,  -- customer, device, verification, user, etc.
    entity_id INTEGER,
...
-- --- 11) Hard Deletes Tombstone (per propagazione eliminazioni definitive) ---
...
-- --- 12) Ecografo Quality Checks & Probes & Controls ---
